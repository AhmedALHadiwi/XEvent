    ...
    <Layout>
      <div className="max-w-sm mx-auto bg-card rounded-xl border shadow-sm p-6">
        ...
        <form className="space-y-3" onSubmit={submit}>
          ...
          <button className="w-full rounded-lg bg-brand text-white px-3 py-2 font-medium">Register</button>
          <div className="text-sm text-muted-foreground text-center">Already have an account? <a className="underline" href="/login">Login</a></div>
        </form>
      </div>
    </Layout>
  );
